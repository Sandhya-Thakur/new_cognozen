...
const QuizSidebarContent: React.FC = () => {
  return (
    <div className="h-full flex flex-col p-4 space-y-6 overflow-y-auto">
      <div className="bg-gray-100 rounded-lg p-4">
        <h2 className="text-xl font-semibold mb-4 text-gray-700">Quiz Webcam</h2>
        <QuizWebcamAnalyzer />
      </div>
      ...
      <div className="bg-gray-100 rounded-lg p-4 flex-grow">
        <h2 className="text-xl font-semibold mb-4 text-gray-700">Quiz Notes</h2>
        <textarea
          ...
          placeholder="Take notes during the quiz..."
        />
      </div>
    </div>
  );
...
export default QuizSidebarContent;